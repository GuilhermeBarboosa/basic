...
import { InscricaoObservableService } from 'src/app/observables/inscricao-observable.service';
...
export class InserirDocComponent implements OnInit {
  ...
  constructor(
    ...
    private inscricaoObservableService:InscricaoObservableService,
  ...
  async ngOnInit() {
    ...
    await this.inscricaoObservableService.inscricaoInput$.subscribe(async (data) => {
