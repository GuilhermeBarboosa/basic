...
export class EditUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userService.getById(this.id).subscribe((res) => {
     ...
     userResponse.data_de_nascimento = this.utilsService.formatarData(
       userResponse.data_de_nascimento
      );
  ...
  edit() {
    if (this.formulario.valid) {
      let userDTO = {
        ...
        data_de_nascimento: this.utilsService.formatarDataToSQL(this.formulario.get('data_de_nascimento')?.value)
      };
